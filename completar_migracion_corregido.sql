-- =====================================================
-- COMPLETAR MIGRACIÓN Y INSERTAR DATOS (CORREGIDO)
-- =====================================================
...
-- 4. Reiniciar las secuencias de ID
ALTER SEQUENCE preguntas_quiz_id_seq RESTART WITH 1;
ALTER SEQUENCE opciones_respuesta_id_seq RESTART WITH 1;
ALTER SEQUENCE configuracion_quiz_id_seq RESTART WITH 1;

-- 5. Insertar preguntas de ejemplo con usuario creador
...
-- 6. Insertar opciones de respuesta con usuario creador
...
-- 8. Verificar que todo se insertó correctamente
