-- =====================================================
-- SISTEMA DE QUIZ DE ADMISIÓN 2025 - VERSIÓN SIMPLIFICADA
-- =====================================================
...
CREATE POLICY "Estudiantes ven sus intentos" ON intentos_quiz
    FOR SELECT USING (true); -- Temporalmente permitir todo
...
-- Política para insertar intentos
CREATE POLICY "Permitir insertar intentos" ON intentos_quiz
    FOR INSERT WITH CHECK (true);

-- Política para insertar respuestas
CREATE POLICY "Permitir insertar respuestas" ON respuestas_estudiante
    FOR INSERT WITH CHECK (true);

-- Política para actualizar intentos
CREATE POLICY "Permitir actualizar intentos" ON intentos_quiz
...
-- Ver todas las preguntas con sus opciones
-- SELECT 
--     pq.id,
--     pq.pregunta,
--     pq.imagen_url,
...
-- WHERE pq.activa = true AND op.activa = true
-- ORDER BY pq.orden_mostrar, op.orden_mostrar;

-- Ver configuración del quiz
-- SELECT * FROM configuracion_quiz WHERE activa = true;

-- Ver intentos de un estudiante específico
-- SELECT * FROM intentos_quiz WHERE estudiante_id = 'ADMIN001';
